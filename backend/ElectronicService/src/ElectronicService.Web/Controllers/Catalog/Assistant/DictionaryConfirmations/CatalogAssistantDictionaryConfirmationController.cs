...
namespace ElectronicService.Web.Controllers.Catalog.Assistant.DictionaryConfirmations;

[ApiController]
[Route("api/catalog/assistant/dictionary-confirmations")]
public sealed class CatalogAssistantDictionaryConfirmationController : ControllerBase
{
    private readonly AddCatalogDictionaryTermCommandHandler _handler;

    public CatalogAssistantDictionaryConfirmationController(
    ...
    public async Task<ActionResult<CatalogDictionaryTermResponse>> Confirm(
        [FromBody] ConfirmCatalogAssistantDictionaryTermRequest request,
