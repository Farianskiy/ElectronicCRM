...
namespace ElectronicService.Infrastructure.Postgres.Migrations
{
    ...
    [Migration("20260820092808_AllowPendingCatalogRecognitionFeedbackDecision")]
    partial class AllowPendingCatalogRecognitionFeedbackDecision
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("catalog_recognition_feedback", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_catalog_recognition_feedback_import_links", "(\"import_batch_id\" IS NULL AND \"import_row_id\" IS NULL) OR (\"import_batch_id\" IS NOT NULL AND \"import_row_id\" IS NOT NULL)");
