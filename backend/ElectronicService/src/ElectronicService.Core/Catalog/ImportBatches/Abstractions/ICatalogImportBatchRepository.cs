...
public interface ICatalogImportBatchRepository
{
    ...
    Task<IReadOnlyCollection<CatalogImportColumn>> GetColumnsForAnalysisAsync(
        Guid batchId,
        CancellationToken cancellationToken = default);

    Task<IReadOnlyCollection<CatalogImportColumn>> GetColumnsForUpdateAsync(
        Guid batchId,
        CancellationToken cancellationToken = default);
    ...
    Task<IReadOnlyCollection<CatalogImportRow>> GetRowsAsync(
        Guid batchId,
    ...
    Task<IReadOnlyCollection<CatalogImportBatch>> GetReviewQueueAsync(
        CatalogImportBatchStatus? status,
        int skip,
        int take,
        CancellationToken cancellationToken = default);

    Task<int> CountReviewQueueAsync(
        CatalogImportBatchStatus? status,
        CancellationToken cancellationToken = default);
