...
function getManufacturer(product: CatalogProductListItem): string {
  return product.manufacturerName ?? product.manufacturer ?? "—";
}

function getProductType(product: CatalogProductListItem): string {
  return product.productTypeName ?? product.productType ?? product.productTypeCode ?? "—";
}
  ...
  const productsQuery = useQuery({
    ...
    queryFn: () =>
      getCatalogProducts({
        ...
        onlyInStock: appliedOnlyInStock,
        page,
        pageSize,
      }),
  });
