...
export default function ProfilePage() {
  ...
  return (
    <div className="grid gap-6">
      <PageHeader
        title="Профиль"
        description="Информация о текущем пользователе и правах доступа."
      />
      ...
      <section className="grid gap-6 lg:grid-cols-[360px_1fr]">
        ...
        <div className="rounded-3xl border border-white/10 bg-white/[0.04] p-6">
          <h2 className="text-xl font-semibold text-white">Права доступа</h2>

          <div className="mt-5 grid gap-3">
            <AccessRow label="Поиск товаров через Assistant" allowed />
            <AccessRow label="Просмотр каталога товаров" allowed />
            <AccessRow
              label="Отправка предложений по неизвестным словам"
              allowed
            />
            <AccessRow label="Просмотр Parsed request" allowed={technical} />
            <AccessRow
